...
interface EditRoleFormProps {
  roleId: number;
  initialData?: { name?: string | null; description?: string | null; permissions?: unknown };
...
export default function EditRoleForm({
  ...
  const { data: role, isLoading } = useSWR(`/api/roles/${roleId}`, fetcher, {
  ...
  const {
    ...
    defaultValues: {
      ...
      permissions: initialData?.permissions || getDefaultPermissions(),
    },
  });
  ...
  if (isLoading) {
    return <div className="p-4 text-center">Loading role details...</div>;
  }
