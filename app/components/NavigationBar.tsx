...
export default function NavigationBar() {
    ...
    return (
        <header className='fixed inset-x-0 z-50 w-full bg-white/80 backdrop-blur-md border-b border-gray-200 py-1 shadow-sm h-[4rem] transition-colors duration-300'>
