...
export default function CustomSignUpForm() {
    ...
    const handleInputChange = (field: keyof Pick<FormData, 'firstname' | 'lastname' | 'username' | 'email' | 'password' | 'confirmPassword'>) => {
                        ...
                        <div className="relative">
                            <input
                                {...register('confirmPassword', {
                                    ...
                                    validate: (value) => value === password || 'Passwords do not match. Try again.',
